        ...
        if actor:IsValid() then
            pcall(function()
                ...
                if ueLootPos then
                    ...
                    -- Defer object deduplication that relies on expensive string allocations and C++ reflection (e.g., actor:GetFullName())
                    -- until *after* fast spatial/distance checks validate the object is nearby.
                    if within then
                        local key = nil
